...
def main():
    ...
    import json
    adapter_config = json.load(open("./adapter_config.json"))
    adapter_config["bottleneck_dim"] = sparse_args.bottleneck_dim
    adapter_config = AdapterConfig.from_dict(adapter_config)
    delta_model = AdapterModel.from_config(adapter_config, backbone_model=model)
