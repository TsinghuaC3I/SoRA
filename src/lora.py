...
class LoraModel(DeltaBase):
    ...
    delta_type = "lora"
    default_modified_modules = ['attn@.q@', 'attn@.v@', 'attn@.k@', 'attn@.proj@', 'ff@.w1@', 'ff@.w2@']
